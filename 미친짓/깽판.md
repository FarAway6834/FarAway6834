...
1. ModelOfFakeInt • Quatro

### ModelOfFakeInt • Quatro
...
```markdown
1. 1을 더해서 0이 되는 수를 (-1)이라 하자.
2. □ + 1 = 0인 □ = -1
3. 수들의 나열 z가, n번째 항목이 (-1)ⁿ⌊n/2⌋라 하자.
4. zₙ = (-1)ⁿ⌊n/2⌋란거임.
5. 이런식으로, 하되, 벡터의 정의는, 중학교용 깽판 참고.
```

## 중학교 수학에 깽판치기

1. hentai-iatnah system • hentinfvec-system
2. 복소수의 정의

### hentai-iatnah system • hentinfvec-system
...
우히히... 실행렬과 실벡터의 정의는 바로...

1. hentai-iatnah system • hentinfvec-system에서 정의한 대로 일단 정의됨
2. 인덱스 기반이니까, 이제 그거 가지고 벡터합이랑 외적 • 내적 정의함.
3. 그리고 행렬곱 • 텐서곱도 쉽게 정의 가능함.
```
...
산술 위에, 수학 기초론을 만들어서, 증명론과 형식증명체계를 구축하자.
